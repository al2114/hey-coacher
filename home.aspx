<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="PresentData.home" %>
...
<head runat="server">
    ...
    <style type="text/css">
        .main {background:yellow; overflow:auto}
    </style>
</head>
<body>
    <div>
    ...
    <div class="main">
        <p>This is a sample website to view the contents of the database.</p>    
    </div>
    <br />
    <footer>&copy; @DateTime.Now - Smart Bike Project Database Content</footer>
