<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rjp.aspx.cs" Inherits="PresentData.rjp" %>
...
<head runat="server">
    ...
    <style type="text/css">
        .main {background:yellow; position:fixed; overflow:auto;}
    </style>
</head>
<body>
    <div>
